...
/*
    ...
    [V,D,options] = ZHERjadamilurevcom_gep_matvec(ANAME,n,MNAME,k,sigma,options,PREC);
...

{
    ...
    mydims[0]=n;
    mydims[1]=1;
    a_m_prec_rhs=(mxArray *)mxCreateNumericArray(2, mydims, mxDOUBLE_CLASS, mxCOMPLEX);
    do {
#ifdef PRINT_INFO
