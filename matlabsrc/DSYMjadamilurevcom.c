...

{
    ...
    size_t     sizebuf;
    double     dbuf, *A_valuesR, *eigs, *res, mem, sigma, shift, sign,
    ...
    mydims[0]=n;
    mydims[1]=1;
    prec_rhs=(mxArray *)mxCreateNumericArray(2, mydims, mxDOUBLE_CLASS, mxREAL);
    do {
#ifdef PRINT_INFO
