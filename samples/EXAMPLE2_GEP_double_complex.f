      PROGRAM EXAMPLE1_GEP_double_complex
...
c     additional parameters set to default
      ...
      ICNTL(5)=0
c     
c     We have the exact matrix: we may call ZPJD_GEP (double complex version)
c
       CALL ZPJD_GEP( N,a,ja,ia, b,jb,ib, EIGS, RES, X, LX, NEIG, 
