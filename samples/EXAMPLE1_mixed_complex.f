...
*     optimal workspace (here MAXSP*MAXSP>MAXEIG)
      ...
      DOUBLEPRECISION  EIGS(MAXEIG), RES(MAXEIG)
      REAL             SEIGS(MAXEIG),SRES(MAXEIG)
      DOUBLECOMPLEX    X(LX)
      COMPLEX          SX(LX)
*     arguments to pass to the routines
      INTEGER     NEIG, MADSPACE, ISEARCH, NINIT, ICNTL(5)
      INTEGER     ITER, IPRINT, INFO
      DOUBLEPRECISION SIGMA, TOL, DELTA, SHIFT, GAP, MEM, DROPTOL
...
c
      ...
      CALL CPJD( N,sa,ja,ia, SEIGS, SRES, SX, LX, NEIG, 
