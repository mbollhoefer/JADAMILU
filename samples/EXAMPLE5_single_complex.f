      PROGRAM EXAMPLE5_single_complex
...
*     arguments to pass to the routines
      ...
      REAL               SIGMA, TOL, VAL, SHIFT, GAP, MEM, DROPTOL
*
...
c     Here we start the computation
      IJOB=0
c     
c     We do not have the exact matrix: we may call PJDREVCOM,
c     single precision version
 10   CALL CPJDREVCOM( N,A,JA,IA, EIGS, RES, X, LX, NEIG, 
...
c     scalar product needed by the rank-1 correction
      VAL=0.0
      do I=0,N-1
         VAL=VAL+X(NDX1+I)
      end do
