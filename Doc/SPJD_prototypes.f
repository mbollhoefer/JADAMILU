*======================================================================*        
*                                                                               
       SUBROUTINE SPJD( N, A, JA, IA, EIGS, RES, X, LX, NEIG,                   
...
*              SPJD/SPJDREVCOM ASSUMES THAT EACH OFF-DIAGONAL ENTRY IS          
...
*                                                                               
*              SPJD ASSUMES IN ADDITION THAT ALL DIAGONAL ELEMENTS ARE          
...
*              above, SPJD assumes that some of these JA(K) (for                
...
*                                                                               
*  X       (input/output+workspace) REAL array, dimension LX.                   
...
*              equal to the value on output from SPJD/SPJDREVCOM.               
*                                                                               
...
*              memory area that is offered by the user, SPJD will               
...
*          ICNTL(1) Not used (kept for compatibility with SPJDREVCOM).          
...
*                   option presumes that SPJD was called previously and         
...
*                                                                               
        ...
        IJOB=0                                                                  
*                                                                               
        CALL spjdrvcom( N, A, JA, IA, B, JB, IB, EIGS, RES, X, LX,              
...
*======================================================================*        
*                                                                               
       SUBROUTINE SPJDREVCOM( N, A, JA, IA, EIGS, RES, X, LX, NEIG,             
...
*  =========                                                                    
*                                                                               
*    N,A,JA,IA,                        |  see comments in subroutine SPJD       
*                                                                               
*       In addition:                                                            
*                                                                               
...
*               passed to SPJDREVCOM is only used to define a                   
...
*                                                                               
*            A,JA,IA should be compliant with the format described in SPJD      
*            However:                                                           
...
*    ITER, TOL, SHIFT, DROPTOL, MEM,   |  see comments in subroutine SPJD       
*                                      |                                        
*    IPRINT, INFO, GAP                 |                                        
*                                                                               
*                                                                               
...
*                   started)                                                    
*          other entries in ICNTL: see comments in subroutine SPJD              
*                                                                               
*                                                                               
...
*                        MATVEC) and return to SPJDREVCOM leaving IJOB          
...
*======================================================================*        
*                                                                               
       SUBROUTINE SJDREVCOM( N, EIGS, RES, X, LX, NEIG, SIGMA,                  
...
*    SIGMA, ISEARCH, NINIT,            |                                        
*    MADSPACE, ITER, TOL,              |  see comments in subroutine SPJD       
*                                      |                                        
*    IPRINT, INFO, GAP                 |                                        
*                                                                               
*                                                                               
...
*                       PSOLVE) and return to SPJDREVCOM leaving IJOB           
*                       (and other parameters) unchanged.                       
*                                                                               
*  NDX1    (output) INTEGER.                                                    
*  NDX2    Indicate indices into X() for the needed MATVEC when IJOB=1,         
...
*                                                                               
       integer NDX3                                                             
*                                                                               
       CALL sjdrvcom( N, EIGS, RES, X, LX, NEIG, SIGMA,                         
...
** ============================================================                 
     ...
     +                  flagsingle                                              
      ...
      external sdglprecdelete,ssymamgdelete                                     
                                                                                
                                                                                
                                                                                
                                                                                
c     make sure that SPJDCLEANUP is not really executed before SPJD/            
c     SPJDREVCOM has been called for the first time                             
      if (ilumem.ne.-1) then                                                    
         if (factdgl.gt.0) then                                                 
            call sdglprecdelete(IPdiag)                                         
...
c        ensure that twice calling SPJDCLEANUP is captured                      
         ilumem=-1                                                              
      end if                                                                    
      factdgl=0                                                                 
c                                                                               
...
*======================================================================*        
*                                                                               
       SUBROUTINE SPJD_GEP( N, A, JA, IA, B, JB, IB, EIGS, RES, X, LX,          
     +                      NEIG, SIGMA, ISEARCH, NINIT, MADSPACE, ITER,        
...
*            storage scheme as for A (see comments in subroutine SPJD).         
...
*    MADSPACE, ITER,                   |  see comments in subroutine SPJD       
*                                      |                                        
*    SHIFT, DROPTOL, MEM,              |                                        
...
*======================================================================*        
*                                                                               
       SUBROUTINE SPJDREVCOM_GEP( N, A, JA, IA, B, JB, IB, EIGS, RES, X,        
...
*               passed to SPJDREVCOM_GEP is only used to define a               
*               preconditioner, whereas matrix vector multiplications           
*               are performed by a user provided routine via the reverse        
*               communication protocol (see below).                             
*                                                                               
*            A,JA,IA and B,JB,IB  should be compliant with the format           
*            described in SPJD.However:                                         
*                  zero diagonal entries need not to be referenced in           
*                        the structure (although they may);                     
*                  if a diagonal preconditioning is wanted, one                 
*                        should set ja(1) negative;                             
...
*                       (call to matrix vector multiplication routine:          
*                        MATVEC) and return to SPJDREVCOM_GEP leaving IJOB      
*                       (and other parameters) unchanged.                       
...
** ============================================================                 
*                                                                               
       CALL spjdrvcom( N, A, JA, IA, B, JB, IB, EIGS, RES, X, LX, NEIG,         
     +                 SIGMA, ISEARCH, NINIT, MADSPACE, ITER, TOL,              
...
*======================================================================*        
*                                                                               
       SUBROUTINE SJDREVCOM_GEP(N, EIGS, RES, X, LX, NEIG, SIGMA,               
     +                          ISEARCH, NINIT, MADSPACE, ITER, TOL,            
...
*               IJOB=2: solve Prec*X(NDX1:NDX1+N-1) = X(NDX2:NDX2+N-1)          
*                       (call to preconditioner solve routine:                  
*                       PSOLVE) and return to SPJDREVCOM_GEP leaving IJOB       
*                       (and other parameters) unchanged.                       
*               IJOB=3: compute X(NDX2:NDX2+N-1)= A*X(NDX1:NDX1+N-1)            
*                       (call to matrix vector multiplication routine:          
*                        MATVEC) and return to SPJDREVCOM_GEP leaving IJOB      
