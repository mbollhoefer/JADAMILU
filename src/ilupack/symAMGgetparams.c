...
void SYMAMGGETPARAMS(ILUPACKPARAM param,
		    ...
		    REALS *restol, integer *max_it)
{
  /*
    ...
    fpar        floating point parameters 
		...
		fpar[21]    absolute error tolerance
		            default: 0
		fpar[22]=
		fpar[23,...30] further parameters used by SPARSKIT solvers
		            default: 0
  ...
  *flags=param.ipar[6];
  //*elbow=param.ipar[0];
  *elbow=param.elbow;
  droptols[0]=param.fpar[0];
  droptols[1]=param.fpar[1];
  *condest=param.fpar[2];

  *restol=param.fpar[20];
  *max_it=param.ipar[25];
